...
/**
 * @brief selects the correct chip select lines with the polarity requested
 *
 * @param cs the chip to select (SPI_CS_0, SPI_CS_1, SPI_CS_2)
 * @param polarity the polarity for the chip select lines (SPI_CS_ACTIVE_HIGH,
 *                 SPI_CS_ACTIVE_LOW)
 */
